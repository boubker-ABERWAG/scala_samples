package fr.aberwag.scala.currying
...
object Main {
  def main(args: Array[String]): Unit = {
    ...
    /*
	   * ote: method modN is partially applied in the two filter calls;
     * i.e. only its first argument is actually applied.
     * The term modN(2) yields a function of type
     * Int => Boolean and is thus a possible candidate for the second argument of function filter.
     */
  }
}